...
public final class CountPrimitiveCallsTest {
    ...
    private void assertCountAndRestore(String fileName, boolean block,
            int expectedCount) {
        Statement s1 = this.createFromArgs(fileName, block);
        Statement s2 = this.createFromArgs(fileName, block);
    ...
    @Test 
    public void test1Block() { 
    	this.assertCountAndRestore("data/test1.bl", true, 25); 
    }
}

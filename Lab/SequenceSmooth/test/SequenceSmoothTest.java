...
public final class SequenceSmoothTest {
    ...
    Sequence<Integer> seq1 = this.createFromArgs(2,3,4);
    Sequence<Integer> expectedSeq1 = this.createFromArgs(2,3,4);
    Sequence<Integer> seq2 = this.createFromArgs(1,5);
    Sequence<Integer> expectedSeq2 = this.createFromArgs(2,3);
    SequenceSmooth.smooth(seq1,seq2);	
    ...
    public void testNegativeNumbers() {
        /* Math: (-10 + -20)/2 = -15, (-20 + 40)/2 = 10 */
        Sequence<Integer> seq1 = this.createFromArgs(-10, -20, 40);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-10, -20, 40);
        Sequence<Integer> seq2 = this.createFromArgs(0, 0); 
        Sequence<Integer> expectedSeq2 = this.createFromArgs(-15, 10);
    ...
    public void testLongSequence() {
        /* s1 length 5, s2 length should be 4 */
        Sequence<Integer> seq1 = this.createFromArgs(0, 10, 0, 10, 0);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(0, 10, 0, 10, 0);
        Sequence<Integer> seq2 = this.createFromArgs(-1, -1, -1, -1);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(5, 5, 5, 5);
